...
\centering
\caption{
\textbf{Summary of long- and short-baseline neutrino experiments.}
Even though DUNE and DUNE-HE share the same baseline and nominal energy range,
the high-energy beam is broader and peaks at larger energies, resulting in different sensitivities.
Table extended from~\cite{DeRomeri:2023dht}. Perhaps sort by operation start.
}
...
\textbf{Baseline} & 
\textbf{Energy Range} & 
\textbf{Main Oscillation Channel} & 
\textbf{Statistics}, Operation (Time) \\ 
\midrule
\textcolor{green!50!black}{KamLAND~[58]} &
$\mathcal{O}(100)$--$\mathcal{O}(1000)$ km &
1.8--8.0 MeV &
$\bar{\nu}_e \to \bar{\nu}_e$ &
$\sim500$ events \\

\textcolor{blue}{Daya Bay~[57]} and \textcolor{red!70!black}{RENO~[56]} &
$\mathcal{O}(100)$--$\mathcal{O}(1000)$ km &
1.8--8.0 MeV &
$\bar{\nu}_e \to \bar{\nu}_e$ &
$10^5$ events \\

\textcolor{black}{T2K~[63]} &
295 km &
0.2--2.0 GeV &
$\nu_\mu (\bar{\nu}_\mu) \to \nu_\mu (\bar{\nu}_\mu)$, 
$\nu_\mu (\bar{\nu}_\mu) \to \nu_e (\bar{\nu}_e)$ &
...
\textcolor{cyan!60!black}{NOvA~[62]} &
812 km &
0.8--5.0 GeV &
$\nu_\mu (\bar{\nu}_\mu) \to \nu_\mu (\bar{\nu}_\mu)$, 
$\nu_\mu (\bar{\nu}_\mu) \to \nu_e (\bar{\nu}_e)$ &
...
\textcolor{red!70!black}{MINOS/MINOS+~[60]} &
735 km &
1--40 GeV &
$\nu_\mu (\bar{\nu}_\mu) \to \nu_\mu (\bar{\nu}_\mu)$ &
$\sim10^4$ events \\

\textcolor{gray!60!black}{JUNO~[65]} &
$\sim53$ km &
1.8--8.0 MeV &
$\bar{\nu}_e \to \bar{\nu}_e$ &
$10^5$--$10^6$ events \\

\textcolor{blue}{DUNE~[96]} &
1285 km &
0.5--20 GeV &
$\nu_\mu (\bar{\nu}_\mu) \to \nu_\mu (\bar{\nu}_\mu)$, 
$\nu_\mu (\bar{\nu}_\mu) \to \nu_e (\bar{\nu}_e)$ &
...
\textcolor{blue!70!black}{DUNE-HE~[97]} &
1285 km &
0.5--20 GeV &
$\nu_\mu (\bar{\nu}_\mu) \to \nu_\mu (\bar{\nu}_\mu)$, 
$\nu_\mu (\bar{\nu}_\mu) \to \nu_e (\bar{\nu}_e)$ &
similar to DUNE, harder spectrum \\
...
quote QD bounds, I have the data in $\verb!DPhil/Travels/LTA/USA/Project/qd_L_vs_.C/!$
