...
%
    \begin{figure}[hbt]
	\centering
	\includegraphics[width=1.\textwidth]{figures/QD_Analysis/RecoNeutrinoEnergy_ByOscChannel_DividedByBinWidth.pdf}
	\caption[Bin-Averaged Event Densities over $E_\nu^\mathrm{rec}$ for the Super-Kamiokande Samples (split into Oscillation Channels).]{Bin-averaged event densities $N / \Delta E_\nu^\mathrm{rec}$ as a function of reconstructed neutrino energy $E_\nu^\mathrm{rec}$ for the Super-Kamiokande (\acrshort{t2k} \acrshort{fd}) samples. The data from \acrshort{t2k} runs $1$ to $11$ are shown as gray dots with horizontal bars showing the bin width and vertical bars the statistical fluctuation. The \acrshort{mc} prediction is shown as a split into oscillation channels for the oscillation parameters as defined in T2K Set A ($\Gamma = 5.0 \times 10^{-15} \ \mathrm{eV}$). \Cref{fig:RecoNeutrinoEnergy_ByOscChannel_Counts} presents the same data undivided by bin width.}
    \label{fig:RecoNeutrinoEnergy_ByOscChannel_DividedByBinWidth}
    \end{figure}
%
...
%
    \begin{figure}[hbt]
	\centering
	\includegraphics[width=1.\textwidth]{figures/QD_Analysis/RecoNeutrinoEnergy_ByIntChannel_DividedByBinWidth.pdf}
	\caption[Bin-Averaged Event Densities over $E_\nu^\mathrm{rec}$ for the Super-Kamiokande Samples (split into Interaction Channels).]{Bin-averaged event densities $N / \Delta E_\nu^\mathrm{rec}$ as a function of reconstructed neutrino energy $E_\nu^\mathrm{rec}$ for the Super-Kamiokande (\acrshort{t2k} \acrshort{fd}) samples. The data from \acrshort{t2k} runs $1$ to $11$ are shown as gray dots with horizontal bars showing the bin width and vertical bars the statistical fluctuation. The \acrshort{mc} prediction is shown broken down into interaction modes for the oscillation parameters as defined in T2K Set A ($\Gamma = 5.0 \times 10^{-15} \ \mathrm{eV}$). \Cref{fig:RecoNeutrinoEnergy_ByIntChannel_Counts} presents the same data undivided by bin width.}
    \label{fig:RecoNeutrinoEnergy_ByIntChannel_DividedByBinWidth}
    \end{figure}
%
...
%
    \begin{figure}[hbt]
	\centering
	\includegraphics[width=1.\textwidth]{figures/QD_Analysis/T2K_A1_A2_side-by-side_comparison.pdf}
	\caption[Bin-Averaged Event Densities over $E_\nu^\mathrm{true}$ for the Super-Kamiokande Samples (split into Oscillation Channels): Effect of Quantum Decoherence.]{Bin-averaged event densities $N / \Delta E_\nu^\mathrm{true}$ as a function of reconstructed neutrino energy $E_\nu^\mathrm{true}$ for the Super-Kamiokande (\acrshort{t2k} \acrshort{fd}) samples: Effect of Quantum Decoherence. The \acrshort{mc} prediction is shown broken down into oscillation channels for the oscillation parameters as defined in T2K Set A with $\Gamma = 0.0 \ \mathrm{eV}$ (left) and $\Gamma = 5.0 \times 10^{-15} \ \mathrm{eV}$ (right).}
    \label{fig:T2K_A1_A2_side-by-side_comparison}
    \end{figure}
%
...
%
    \begin{figure}[hbt]
	\centering
	\includegraphics[width=1.\textwidth]{figures/QD_Analysis/T2K_B3_B4_side-by-side_comparison.pdf}
	\caption[Bin-Averaged Event Densities over $E_\nu^\mathrm{true}$ for the Super-Kamiokande Samples (split into Oscillation Channels): Effect of Quantum Decoherence.]{Bin-averaged event densities $N / \Delta E_\nu^\mathrm{true}$ as a function of reconstructed neutrino energy $E_\nu^\mathrm{true}$ for the Super-Kamiokande (\acrshort{t2k} \acrshort{fd}) samples: Effect of Quantum Decoherence. The \acrshort{mc} prediction is shown broken down into oscillation channels for the oscillation parameters as defined in T2K Set B with $\Gamma = 0.0 \ \mathrm{eV}$ (left) and $\Gamma = 5.0 \times 10^{-15} \ \mathrm{eV}$ (right).}
    \label{fig:T2K_B3_B4_side-by-side_comparison}
    \end{figure}
%
...
\begin{landscape}
    ...
    {figures/QD_Analysis/T2K_A1_A2_B3_B4_side-by-side_comparison.pdf}
    \caption[]{.}
	\label{fig:T2K_A1_A2_B3_B4_side-by-side_comparison}
    \end{figure}
%
\end{landscape}
%
...
%
    ...
    {figures/QD_Analysis/RecoNeutrinoEnergy_total_ratio_counts.pdf}
    %{figures/QD_Analysis/RecoNeutrinoEnergy_total_counts.pdf}
	\caption[Events over $E_\nu^\mathrm{rec}$ for the Super-Kamiokande Samples.]{Events per bin as a function of reconstructed neutrino energy $E_\nu^\mathrm{rec}$ for the Super-Kamiokande (\acrshort{t2k} \acrshort{fd}) samples for four sets of oscillation parameters T2K Set A (with $\Gamma = 0$, solid blue; $\Gamma = 5.0 \times 10^{-15}\ \text{eV}$, dashed blue) and T2K Set B (with $\Gamma = 0$, solid brown; $\Gamma = 5.0 \times 10^{-15}\ \text{eV}$, dashed brown). \Cref{fig:RecoNeutrinoEnergy_total_density} presents the same data divided by bin width.}
    \label{fig:RecoNeutrinoEnergy_total_counts}
    \end{figure}
%
...
%
    \begin{figure}[hbt]
	\centering
	\includegraphics[width=1.\textwidth]{figures/QD_Analysis/RecoNeutrinoEnergy_total_counts_horizontal.pdf}
	\caption[Events over $E_\nu^\mathrm{rec}$ for the Super-Kamiokande Samples.]{Events per bin as a function of reconstructed neutrino energy $E_\nu^\mathrm{rec}$ for the Super-Kamiokande (\acrshort{t2k} \acrshort{fd}) samples for four sets of oscillation parameters T2K Set A (with $\Gamma = 0$, solid blue; $\Gamma = 5.0 \times 10^{-15}\ \text{eV}$, dashed blue) and T2K Set B (with $\Gamma = 0$, solid brown; $\Gamma = 5.0 \times 10^{-15}\ \text{eV}$, dashed brown). \Cref{fig:RecoNeutrinoEnergy_total_density} presents the same data divided by bin width.}
    \label{fig:RecoNeutrinoEnergy_total_counts_horizontal}
    \end{figure}
%
...
%
    \begin{figure}[hbt]
	\centering
	\includegraphics[width=0.9\textwidth]{figures/QD_Analysis/TrueNeutrinoEnergy_total_ratio_counts.pdf}%{figures/QD_Analysis/TrueNeutrinoEnergy_total_counts.pdf}
	\caption[Events over $E_\nu^\mathrm{true}$ for the Super-Kamiokande Samples.]{Events per bin as a function of reconstructed neutrino energy $E_\nu^\mathrm{true}$ for the Super-Kamiokande (\acrshort{t2k} \acrshort{fd}) samples for four sets of oscillation parameters T2K Set A (with $\Gamma = 0$, solid blue; $\Gamma = 5.0 \times 10^{-15}\ \text{eV}$, dashed blue) and T2K Set B (with $\Gamma = 0$, solid brown; $\Gamma = 5.0 \times 10^{-15}\ \text{eV}$, dashed brown). \Cref{fig:TrueNeutrinoEnergy_total_density} presents the same data divided by bin width.}
    \label{fig:TrueNeutrinoEnergy_total_counts}
    \end{figure}
%
...
%
    \begin{figure}[hbt]
	\centering
	\includegraphics[width=.9\textwidth]{figures/QD_Analysis/RecoNeutrinoEnergy_total_ratio_density.pdf}%{figures/QD_Analysis/RecoNeutrinoEnergy_total_density.pdf}
	\caption[Bin-Averaged Event Densities over $E_\nu^\mathrm{rec}$ for the Super-Kamiokande Samples.]{Bin-averaged event densities $N / \Delta E_\nu^\mathrm{rec}$ as a function of reconstructed neutrino energy $E_\nu^\mathrm{rec}$ for the Super-Kamiokande (\acrshort{t2k} \acrshort{fd}) samples for four sets of oscillation parameters T2K Set A (with $\Gamma = 0$, solid blue; $\Gamma = 5.0 \times 10^{-15}\ \text{eV}$, dashed blue) and T2K Set B (with $\Gamma = 0$, solid brown; $\Gamma = 5.0 \times 10^{-15}\ \text{eV}$, dashed brown). \Cref{fig:RecoNeutrinoEnergy_total_counts} presents the same data undivided by bin width.}
    \label{fig:RecoNeutrinoEnergy_total_density}
    \end{figure}
%
...
%
    \begin{figure}[hbt]
	\centering
	\includegraphics[width=.9\textwidth]{figures/QD_Analysis/TrueNeutrinoEnergy_total_ratio_density.pdf}%{figures/QD_Analysis/TrueNeutrinoEnergy_total_density.pdf}
	\caption[Bin-Averaged Event Densities over $E_\nu^\mathrm{true}$ for the Super-Kamiokande Samples.]{Bin-averaged event densities $N / \Delta E_\nu^\mathrm{true}$ as a function of reconstructed neutrino energy $E_\nu^\mathrm{true}$ for the Super-Kamiokande (\acrshort{t2k} \acrshort{fd}) samples for four sets of oscillation parameters T2K Set A (with $\Gamma = 0$, solid blue; $\Gamma = 5.0 \times 10^{-15}\ \text{eV}$, dashed blue) and T2K Set B (with $\Gamma = 0$, solid brown; $\Gamma = 5.0 \times 10^{-15}\ \text{eV}$, dashed brown). \Cref{fig:TrueNeutrinoEnergy_total_counts} presents the same data undivided by bin width.}
    \label{fig:TrueNeutrinoEnergy_total_density}
    \end{figure}
%


The \acrshort{t2k} \acrshort{fd} called Super-Kamiokande (\acrshort{t2k} \acrshort{fd}) is a Cherenkov detector filled with Gadolinium-doped water. The event selection is performed by identifying Cherenkov rings produced by muons or electrons originating from $\nu_\mu$ or $\nu_e$-like interactions inside Super-Kamiokande. A \acrshort{fhc} $\nu_\mu$ \acrshort{cc}$1\pi^+$ event is identified by a primary muon ring which has a decay electron and also has an additional decay electron from the pion decay. The \acrshort{fhc} $\nu_e$ \acrshort{cc}$1\pi^+$ event looks for an associated primary electron ring with an associated decay electron from the invisible pion decay. %{\color{red} More details on samples?}
