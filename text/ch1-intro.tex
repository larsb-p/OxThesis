...
\vspace{2mm}
\section{Introduction} \label{introduction} \vspace{-3mm}
...
\begin{figure}[H]
    ...
    \includegraphics[width=\textwidth]{figures/dune_lbl_logo_osc_prob}
	\end{minipage}
	%\begin{minipage}[b]{.51\textwidth}
	%\includegraphics[width=\textwidth]{figures/T2K_lbl_logo.pdf}
    \begin{minipage}[b]{.52\textwidth}
    \includegraphics[width=\textwidth]{figures/T2K_lbl_logo_osc_prob}
	\end{minipage}
